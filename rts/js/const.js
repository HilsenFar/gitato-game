...
RTS.STR_EN = {
  ...
  queueLabel: 'queue',
  replayLast: 'Watch last game',
  replayLoad: 'Load replay…',
  saveReplay: 'Save replay',
  replayNone: 'No replay saved on this device yet',
  replayBad: 'Not a valid replay file',
  replayVersion: 'Replay from another game version — playback may diverge',
  replayEnded: 'REPLAY ENDED',
  replayWinnerIs: '{color} wins',
  replayDrift: 'playback diverged from the recorded game',
  replayLabel: 'REPLAY',
  upDescr: {
...
RTS.STR_DA = {
  ...
  queueLabel: 'kø',
  replayLast: 'Se seneste kamp',
  replayLoad: 'Indlæs replay…',
  saveReplay: 'Gem replay',
  replayNone: 'Intet replay gemt på denne enhed endnu',
  replayBad: 'Ikke en gyldig replay-fil',
  replayVersion: 'Replay fra en anden spilversion — afspilningen kan afvige',
  replayEnded: 'REPLAY SLUT',
  replayWinnerIs: '{color} vinder',
  replayDrift: 'afspilningen afveg fra den optagede kamp',
  replayLabel: 'REPLAY',
  upDescr: {
